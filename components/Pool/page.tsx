...
const Pool = (props: Props) => {
  ...
  <div className="flex-col flex justify-center items-center w-full mt-6 relative">
    ...
    <button type="button" onClick={() => setDexName('uniswap_v3')} className={dexname === 'uniswap_v3' ? "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 bg-gradient-to-tl to-transparent via-fuchsia-700/50 from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center" : "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 hover:bg-gradient-to-tl hover:to-transparent hover:via-slate-700/50 hover:from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center"}><img src="./assets/uniswap_v3.svg" alt="Uniswap V3 Logo" className="size-4"/> Uniswap<small>v3</small></button>
    <button type="button" onClick={() => setDexName('uniswap_v2')} className={dexname === 'uniswap_v2' ? "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 bg-gradient-to-tl to-transparent via-fuchsia-700/50 from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center" : "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 hover:bg-gradient-to-tl hover:to-transparent hover:via-slate-700/50 hover:from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center"}><img src="https://cryptologos.cc/logos/uniswap-uni-logo.svg?v=029" alt="Uniswap V2 Logo" className="size-4"/> Uniswap<small>v2</small></button>
    <button type="button" onClick={() => setDexName('pancakeswap_v2')} className={dexname === 'pancakeswap_v2' ? "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 bg-gradient-to-tl to-transparent via-fuchsia-700/50 from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center" : "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 hover:bg-gradient-to-tl hover:to-transparent hover:via-slate-700/50 hover:from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center"}><img src="https://cryptologos.cc/logos/pancakeswap-cake-logo.svg?v=029" alt="Ethereum Logo" className="size-4"/> Pancakeswap</button>
    <button type="button" onClick={() => setDexName('raydium')} className={dexname === 'raydium' ? "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 bg-gradient-to-tl to-transparent via-fuchsia-700/50 from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center" : "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 hover:bg-gradient-to-tl hover:to-transparent hover:via-slate-700/50 hover:from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center"}><img src="https://s1.coincarp.com/logo/1/raydium.png?style=200&v=1631063519" alt="Ethereum Logo" className="size-4"/> Raydium</button>
    <button type="button" onClick={() => setDexName('stonfi')} className={dexname === 'stonfi' ? "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 bg-gradient-to-tl to-transparent via-fuchsia-700/50 from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center" : "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 hover:bg-gradient-to-tl hover:to-transparent hover:via-slate-700/50 hover:from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center"}><img src="https://ton.app/media/0f34939b-44b1-4be6-9ac1-2f97d61655d4.png?w=640&q=50" alt="Ethereum Logo" className="size-4"/> Stonfi</button>
    <button type="button" onClick={() => setDexName('aerodrome-base')} className={dexname === 'aerodrome-base' ? "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 bg-gradient-to-tl to-transparent via-fuchsia-700/50 from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center" : "px-3 py-1 border-[1px] border-white/20 rounded-md text-white/75 hover:bg-gradient-to-tl hover:to-transparent hover:via-slate-700/50 hover:from-transparent transition-all duration-300 ease-in-out outline-none flex gap-x-1 items-center"}><img src="https://aerodrome.finance/brand-kit/symbol.png" alt="Ethereum Logo" className="size-4"/> Aerodrome</button>
    </div>
