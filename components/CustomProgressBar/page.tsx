...
const CustomProgressBar: React.FC<CustomProgressBarProps> = ({ buys, sells,title1,title2 }) => {
  ...
  return (
    <div style={{ borderRadius: '5px',marginTop:'5px',marginBottom:'5px' }} className="w-72 block max-md:inline-block max-md:w-80">
      <div className="flex max-md:w-80">
      ...
      <div className="flex justify-between items-center w-full max-md:w-80">
