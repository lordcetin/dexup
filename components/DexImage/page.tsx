...
const DexImage = ({dex,size}: Props) => {
  ...
  <>
    ...
    <img src="https://seekvectors.com/storage/images/SushiSwap-01.svg" alt="Pancakeswap Logo" className={`size-${size}`}/>
    : dex === 'thruster-v3' ?
    <img src="https://edgein-image-upload-rmdev-new.s3.us-west-2.amazonaws.com/1705412981825.png" alt="Thruster Logo" className={`size-${size}`}/>
    : dex === 'dogeswap' ?
    <img src="https://s2.coinmarketcap.com/static/img/coins/64x64/12078.png" alt="Dogeswap Logo" className={`size-${size} rounded-full`}/>
    : dex === 'sushiswap' ?
    <img src="https://seekvectors.com/storage/images/SushiSwap-01.svg" alt="Pancakeswap Logo" className={`size-${size}`}/>
